...
VersaTiles class is a wrapper around a `*.versatiles` container that allows to access all tiles, metadata and other properties. <sup><a href="https://github.com/versatiles-org/node-versatiles/blob/7fa5d6b/versatiles/src/index.ts#L26">\[src]</a></sup>

### constructor: `new VersaTiles(source, options)`

Creates a new VersaTiles instance. <sup><a href="https://github.com/versatiles-org/node-versatiles/blob/7fa5d6b/versatiles/src/index.ts#L42">\[src]</a></sup>
...
This is used internally. <sup><a href="https://github.com/versatiles-org/node-versatiles/blob/7fa5d6b/versatiles/src/index.ts#L73">\[src]</a></sup>
...
If there is no metadata in the container, this function returns `null`. <sup><a href="https://github.com/versatiles-org/node-versatiles/blob/7fa5d6b/versatiles/src/index.ts#L133">\[src]</a></sup>
...
The keys of this `map` have the form "{z},{x},{y}". <sup><a href="https://github.com/versatiles-org/node-versatiles/blob/7fa5d6b/versatiles/src/index.ts#L159">\[src]</a></sup>
...
This is used internally to keep a lookup of every tile in the block. <sup><a href="https://github.com/versatiles-org/node-versatiles/blob/7fa5d6b/versatiles/src/index.ts#L237">\[src]</a></sup>
...
If the tile cannot be found, `null` is returned. <sup><a href="https://github.com/versatiles-org/node-versatiles/blob/7fa5d6b/versatiles/src/index.ts#L266">\[src]</a></sup>
...
If the tile cannot be found, `null` is returned. <sup><a href="https://github.com/versatiles-org/node-versatiles/blob/7fa5d6b/versatiles/src/index.ts#L313">\[src]</a></sup>
...
For more details, refer to [spec v02](https://github.com/versatiles-org/versatiles-spec/blob/main/v02/readme.md#block_index). <sup><a href="https://github.com/versatiles-org/node-versatiles/blob/7fa5d6b/versatiles/src/interfaces.ts#L85">\[src]</a></sup>
**Properties**
...
Interface for the metadata header of a `*.Versatiles` container. <sup><a href="https://github.com/versatiles-org/node-versatiles/blob/7fa5d6b/versatiles/src/interfaces.ts#L52">\[src]</a></sup>
**Properties**
...
Interface for defining the options available for reading a container. <sup><a href="https://github.com/versatiles-org/node-versatiles/blob/7fa5d6b/versatiles/src/interfaces.ts#L119">\[src]</a></sup>
**Properties**
...
Interface for the index structure used for tiles within a block. <sup><a href="https://github.com/versatiles-org/node-versatiles/blob/7fa5d6b/versatiles/src/interfaces.ts#L108">\[src]</a></sup>
**Properties**
...
`null` signifies that the data is uncompressed. <sup><a href="https://github.com/versatiles-org/node-versatiles/blob/7fa5d6b/versatiles/src/interfaces.ts#L5">\[src]</a></sup>

**Type:** `"gzip" | "br" | null`

## Type: `Format`<a id="type_format"></a>

Supported tile formats. <sup><a href="https://github.com/versatiles-org/node-versatiles/blob/7fa5d6b/versatiles/src/interfaces.ts#L11">\[src]</a></sup>
...
This can be useful for accessing data stored in various storage mediums. <sup><a href="https://github.com/versatiles-org/node-versatiles/blob/7fa5d6b/versatiles/src/interfaces.ts#L33">\[src]</a></sup>
