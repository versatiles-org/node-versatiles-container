...
import HttpReader from './lib/reader_http';
import FileReader from './lib/reader_file';
import { decompress } from './lib/decompress';
import type { Block, Compression, Format, Header, OpenOptions, Reader, TileIndex } from './lib/interfaces';
export type { Compression, Format, Header, OpenOptions, Reader } from './lib/interfaces';
